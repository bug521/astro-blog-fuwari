...
本项目旨在解决这些问题，提供一个**自动化**、**灵活**、**智能**的Notion到静态博客的转换方案。
...
- **Git忽略**: `config.yaml`加入`.gitignore`
...
本项目通过精心设计的架构，实现了一个**自动化**、**灵活**、**高效**的Notion到静态博客的转换方案。核心亮点包括：
